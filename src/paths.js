export const paths = {
  ...
  dashboard: {
    ...
    campaigns: {
      ...
      createCampaign: '/dashboard/campaigns/createCampaign',
    },

    microsite: {
      index: '/dashboard/microsite',
      multi: '/dashboard/microsite/MultiStepForm',
      micrositeDetails: '/dashboard/microsite/:contentId',
      micrositeCreate: '/dashboard/microsite/create'
    },

    comissions: {
      index: '/dashboard/comissions',
      comissionByPolicy: '/dashboard/comissions/policyView',
      comissionDetails: '/dashboard/blog/:postId'
    },
    ...
    leads: {
      ...
      details: '/dashboard/leads/:customerId',
      edit: '/dashboard/leads/:customerId/edit'
    },
    ecommerce: '/dashboard/ecommerce',
    fileManager: '/dashboard/file-manager',

    policyManager: '/dashboard/policy-manager',
    invoices: {
